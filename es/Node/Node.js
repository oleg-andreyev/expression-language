define(["require", "exports", "../lib/is-scalar", "../lib/addcslashes"], function (require, exports, is_scalar_1, addcslashes_1) {
    "use strict";
    ...
    var Node = /** @class */ (function () {
        ...
        Node.prototype.dump = function () {
            ...
            for (var _i = 0, _a = this.toArray(); _i < _a.length; _i++) {
                var v = _a[_i];
                dump += (0, is_scalar_1.is_scalar)(v) ? v : v.dump();
            }
            return dump;
        };
        Node.prototype.dumpString = function (value) {
            return "\"".concat((0, addcslashes_1.addcslashes)(value, "\0\t\"\\"), "\"");
        };
