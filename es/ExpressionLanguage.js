define(["require", "exports", "./Lexer", "./Parser", "./Compiler", "./ParsedExpression", "./Cache/ArrayAdapter", "./LogicException"], function (require, exports, Lexer_1, Parser_1, Compiler_1, ParsedExpression_1, ArrayAdapter_1, LogicException_1) {
    ...
    var ExpressionLanguage = /** @class */ (function () {
        function ExpressionLanguage(cache, providers) {
            ...
            this.functions = [];
            this.parser = null;
            this.cache = cache || new ArrayAdapter_1.default();
        ...
        ExpressionLanguage.prototype.parse = function (expression, names) {
            if (expression instanceof ParsedExpression_1.default) {
                return expression;
            }
            var cacheKeyItems = [];
            ...
            if (null === parsedExpression) {
                var nodes = this.getParser().parse((0, Lexer_1.tokenize)(expression), names);
                parsedExpression = new ParsedExpression_1.default(expression, nodes);
        ...
        ExpressionLanguage.prototype.register = function (name, compiler, evaluator) {
            if (null !== this.parser) {
                throw new LogicException_1.default("Registering functions after calling evaluate(), compile(), or parse() is not supported.");
            }
        ...
        ExpressionLanguage.prototype.getParser = function () {
            if (null === this.parser) {
                this.parser = new Parser_1.default(this.functions);
            }
            return this.parser;
        };
        ExpressionLanguage.prototype.getCompiler = function () {
            if (null === this.compiler) {
                this.compiler = new Compiler_1.default(this.functions);
            }
